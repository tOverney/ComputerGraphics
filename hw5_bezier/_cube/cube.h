...
public:
    ...
    void init(){
        ...
        // Position buffer
        const GLfloat position[] = {-0.25f, -0.25f,  0.5f,  // left, bottom, front
                                     0.25f, -0.25f,  0.5f,  // right, bottom, front
                                     0.25f,  0.25f,  0.5f,  // right, top, front
                                    -0.25f,  0.25f,  0.5f,  // left, top, front
                                    -0.25f, -0.25f,  0.0f,  // left, bottom, back
                                     0.25f, -0.25f,  0.0f,  // right, bottom, back
                                     0.25f,  0.25f,  0.0f,  // right, top, back
                                    -0.25f,  0.25f,  0.0f}; // left, top, back*/
